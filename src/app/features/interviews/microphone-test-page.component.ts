...
@Component({
  standalone: true,
  selector: "app-microphone-test-page",
  imports: [MatButtonModule],
  templateUrl: "./microphone-test-page.component.html",
...
export class MicrophoneTestPageComponent implements OnDestroy {
  ...
  continue(): void {
    ...
    this.api
      ...
      .subscribe({
        next: () =>
          void this.router.navigate(["/app/interviews", this.id, "room"]),
        error: (error) =>
